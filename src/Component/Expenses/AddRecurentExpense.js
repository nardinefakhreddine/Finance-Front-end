...
class AddReccurentExpense extends Component {
                        ...
                        <div className="card-body">
                            ...
                            <form onSubmit={this.handleFormSubmit}>
                                ...
                                <div class="form-group col-md-14">
                                    ...
                                    <select id="category_id" name="category_id" onChange={this.handleInputChange} class="form-control">
                                        {
...
export default AddReccurentExpense;